...
public class AudioFileAdapterIdSongs extends RecyclerView.Adapter<AudioFileAdapterIdSongs.ViewHolder> {
    ...
    public AudioFileAdapterIdSongs(ArrayList<AudioModel> songsList, Context context, ArrayList<String> IdSongs, RecyclerView recyclerViewId) {
