...
public class AudioFileAdapterArtistSongs extends RecyclerView.Adapter<AudioFileAdapterArtistSongs.ViewHolder> {
    ...
    public AudioFileAdapterArtistSongs(ArrayList<AudioModel> songsList, Context context, String NameArtist, RecyclerView recyclerViewArtist) {
    ...
    private void filterSongs(String searchText) {
        ...
        for (AudioModel song : songsList) {
            if (song.getArtist().toLowerCase(Locale.getDefault()).contains(searchQuery)) {
